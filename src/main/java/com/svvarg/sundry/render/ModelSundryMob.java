 ...
 * @author Swarg
 */
public class ModelSundryMob extends ModelBase
{
    //fields
    ...
    ModelRenderer breastRight;
    ModelRenderer breastLeft;

    public ModelSundryMob()
    {
        textureWidth = 64;
        textureHeight = 64;
        ...
        breastLeft = new ModelRenderer(this, 22, 20);
        breastLeft.addBox(0.5F, 1F, 0F, 3, 3, 2);
        breastLeft.setRotationPoint(0F, 1F, -1.5F);
        breastLeft.setTextureSize(64, 64);
        breastLeft.mirror = true;
        setRotation(breastLeft, -0.5615003F, 0F, 0F);
        breastRight = new ModelRenderer(this, 19, 19);
        breastRight.addBox(-3.5F, 1F, 0F, 3, 3, 2);
        breastRight.setRotationPoint(0F, 1F, -1.5F);
        breastRight.setTextureSize(64, 64);
        breastRight.mirror = true;
        setRotation(breastRight, -0.5615003F, 0F, 0F);
    }
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        rightleg.render(f5);
        leftleg.render(f5);        
        breastRight.render(f5);
        breastLeft.render(f5);
    }
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity)
    {
        ...
        if (this.onGround > -9990.0F)
        {
            ...
            this.rightarm.rotateAngleY += this.body.rotateAngleY * 2F;
