...
public class WorldGenSundryDungeon extends WorldGenerator
{
    ...
    public boolean generate_r0(World world, Random rand, int x, int y, int z)
    {
        ...
        world.setBlock(x + 1, y + 1, z + 5, Sundry.sStone, 8, 3);
        ...
        world.setBlock(x + 5, y + 1, z + 5, Sundry.sStone, 8, 3);
        ...
        world.setBlock(x + 1, y + 2, z + 5, Sundry.sStone, 8, 3);
        ...
        world.setBlock(x + 5, y + 2, z + 5, Sundry.sStone, 8, 3);
